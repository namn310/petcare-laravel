            ...
            <div class="tile">
                <div class="tile-body">
                    ...
                    <div class="button-function d-flex justify-content-between mt-3 mb-4" style="width:70%">
                        ...
                        <button id="uploadfile" class="btn btn-success" type="button" title="Nhập" ><a id="addnhanvien" href="index.php?controller=nhanvien&action=create"><i class="fas fa-plus"></i>>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a style="text-decoration:none;color:white" href="index.php?controller=nhanvien&action=delete&id"> <button type="button" class="btn btn-primary">Xác nhận</button> </a>
